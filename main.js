(function() {
  ...
  class JupyterReader {
    ...
    renderNotebook(filename) {
      ...
      this.$container.className = "notebook-viewer";
    ...
    createCellElement(cell, index) {
      ...
      badge.className = `cell-type-badge ${cell.cell_type}`;
      badge.textContent = cell.cell_type;
      header.appendChild(badge);

      if (cell.cell_type === "code" && cell.execution_count) {
        const cellNum = document.createElement("span");
        cellNum.className = "cell-number";
        cellNum.textContent = `In [${cell.execution_count}]:`;
      ...
      if (cell.cell_type === "code") {
        ...
        prompt.textContent = cell.execution_count ? `[${cell.execution_count}]` : "[ ]";
        ...
        content.innerHTML = this.renderMarkdown(source);
      } else {
        content.className = "cell-content";
    ...
    renderOutput(output, executionCount) {
      ...
      if (output.output_type === "stream") {
        ...
        prompt.textContent = executionCount ? `Out[${executionCount}]:` : "Out[ ]:";
        promptArea.appendChild(prompt);

        const outputContent = document.createElement("div");
        outputContent.className = "output output-stream";
        ...
        const outputContent = document.createElement("div");
        outputContent.className = "output output-result";
        ...
        errorContent.className = "output output-error";
