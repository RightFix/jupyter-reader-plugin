...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)})()}function a(p,c){(c==null||c>p.length)&&(c=p.length);for(var h=0,m=Array(c);h<c;h++)m[h]=p[h];return m}var g=["svg","path","circle","rect","line","polyline","polygon","ellipse","g","defs","use","symbol","text","tspan","textPath","marker","linearGradient","radialGradient"];function u(){for(var p=arguments.length,c=new Array(p),h=0;h<p;h++)c[h]=arguments[h];if(typeof c[1]=="string"||typeof c[2]=="string"){var m=s(c,1)[0],b=typeof c[2]=="string"?c[2]:void 0,f=typeof c[1]=="string"?c[1]:void 0,x=c.find((function(O){return O&&!Array.isArray(O)&&(0,o.A)(O)==="object"}))||{},y=c.find((function(O){return Array.isArray(O)}))||[];return b&&(x.id=b),f&&(x.className=f),k(m,y,x)}if(c=c.filter((function(O){return O!=null})),Array.isArray(c[1])){var E=s(c,3),S=E[0],z=E[1],R=z===void 0?[]:z,L=E[2];return k(S,R,L===void 0?{}:L)}var C=s(c,3),X=C[0],I=C[1],Ne=I===void 0?{}:I,de=C[2];return k(X,de===void 0?[]:de,Ne)}function k(p){var c,h=arguments.length>1&&arguments[1]!==void 0?arguments[1]:[],m=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};if(Array.isArray(m)&&(h=m,m={}),typeof p=="function")return p(m,h);if(p instanceof Node)c=p;else{if(typeof p!="string")throw new Error("Invalid tag ".concat((0,o.A)(p)));c=g.includes(p)?document.createElementNS("http://www.w3.org/2000/svg",p):document.createElement(p)}!m.children&&Array.isArray(h)&&h.length&&(m.children=h);var b=m.ref;return delete m.ref,Object.keys(m).forEach((function(f){var x=m[f];if(x!==void 0)switch(f){case"child":d(c,[x]);break;case"children":if(!Array.isArray(x))throw new Error("children must be an array of Nodes");d(c,x.flat());break;case"attr":Object.keys(x).forEach((function(S){var z=x[S];z!==void 0&&c.setAttribute(S,z)}));break;case"style":typeof x=="string"?c.setAttribute("style",x):Object.keys(x).forEach((function(S){var z=x[S];z!==void 0&&(c.style[S]=z)}));break;case"dataset":for(var y in x){var E=x[y];if(E===void 0)return;c.dataset[y]=E}break;case"on":Object.keys(x).forEach((function(S){var z=x[S];z!==void 0&&z.forEach((function(R){c.addEventListener(S,R)}))}));break;default:g.includes(p)&&["number","string","bigint"].includes((0,o.A)(x))||/-/.test(f)?c.setAttribute(f,x):c[f]=x}})),b&&b.instanceOfRef&&(b.el=c),c}function d(p,c){var h,m=(function(f,x){var y=typeof Symbol!="undefined"&&f[Symbol.iterator]||f["@@iterator"];if(!y){if(Array.isArray(f)||(y=(function(C,X){if(C){if(typeof C=="string")return a(C,X);var I={}.toString.call(C).slice(8,-1);return I==="Object"&&C.constructor&&(I=C.constructor.name),I==="Map"||I==="Set"?Array.from(C):I==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(I)?a(C,X):void 0}})(f))||x&&f&&typeof f.length=="number"){y&&(f=y);var E=0,S=function(){};return{s:S,n:function(){return E>=f.length?{done:!0}:{done:!1,value:f[E++]}},e:function(C){throw C},f:S}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var z,R=!0,L=!1;return{s:function(){y=y.call(f)},n:function(){var C=y.next();return R=C.done,C},e:function(C){L=!0,z=C},f:function(){try{R||y.return==null||y.return()}finally{if(L)throw z}}}})(c);try{for(m.s();!(h=m.n()).done;){var b=h.value;Array.isArray(b)?d(p,b.flat()):(b=w(b))&&p.appendChild(b)}}catch(f){m.e(f)}finally{m.f()}}function w(p){if(typeof p=="function")return w(p());if(p instanceof Promise){var c=document.createTextNode("");p.then((function(m){if(Array.isArray(m))return(m=m.flat()).forEach((function(b){(b=w(b))&&c.before(b)})),void c.remove();(m=w(m))?c.replaceWith(m):c.remove()})),p=c}else if(p instanceof Text)"clone"in p&&(p=p.clone());else if(!(p instanceof Node)){var h=(0,o.A)(p);if(!["number","bigint","string"].includes(h)||h==="string"&&!p)return null;p=u.text("".concat(p))}return p}return window&&!window.tag&&(window.tag=u),Object.defineProperties(u,{get:{value:function(p){return document.querySelector(p)}},getAll:{value:function(p){var c=document.querySelectorAll(p);return(0,i.A)(c)}},text:{value:function(p){return document.createTextNode(p)}}}),n.default})()}))});var T=Fe(me());function se(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var D=se();function $e(l){D=l}var ve=/[&<>"']/,Be=new RegExp(ve.source,"g"),Ae=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Qe=new RegExp(Ae.source,"g"),Ue={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ke=l=>Ue[l];function _(l,e){if(e){if(ve.test(l))return l.replace(Be,ke)}else if(Ae.test(l))return l.replace(Qe,ke);return l}var Ge=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function We(l){return l.replace(Ge,(e,t)=>(t=t.toLowerCase(),t==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}var Xe=/(^|[^\[])\^/g;function v(l,e){let t=typeof l=="string"?l:l.source;e=e||"";let n={replace:(i,o)=>{let r=typeof o=="string"?o:o.source;return r=r.replace(Xe,"$1"),t=t.replace(i,r),n},getRegex:()=>new RegExp(t,e)};return n}function xe(l){try{l=encodeURI(l).replace(/%25/g,"%")}catch(e){return null}return l}var Q={exec:()=>null};function be(l,e){let t=l.replace(/\|/g,(o,r,s)=>{let a=!1,g=r;for(;--g>=0&&s[g]==="\\";)a=!a;return a?"|":" |"}),n=t.split(/ \|/),i=0;if(n[0].trim()||n.shift(),n.length>0&&!n[n.length-1].trim()&&n.pop(),e)if(n.length>e)n.splice(e);else for(;n.length<e;)n.push("");for(;i<n.length;i++)n[i]=n[i].trim().replace(/\\\|/g,"|");return n}function K(l,e,t){let n=l.length;if(n===0)return"";let i=0;for(;i<n;){let o=l.charAt(n-i-1);if(o===e&&!t)i++;else if(o!==e&&t)i++;else break}return l.slice(0,n-i)}function Je(l,e){if(l.indexOf(e[1])===-1)return-1;let t=0;for(let n=0;n<l.length;n++)if(l[n]==="\\")n++;else if(l[n]===e[0])t++;else if(l[n]===e[1]&&(t--,t<0))return n;return-1}function ye(l,e,t,n){let i=e.href,o=e.title?_(e.title):null,r=l[1].replace(/\\([\[\]])/g,"$1");if(l[0].charAt(0)!=="!"){n.state.inLink=!0;let s={type:"link",raw:t,href:i,title:o,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=!1,s}return{type:"image",raw:t,href:i,title:o,text:_(r)}}function Ke(l,e){let t=l.match(/^(\s+)(?:```)/);if(t===null)return e;let n=t[1];return e.split(`
...
`,1)[0],w=0;this.options.pedantic?(w=2,a=k.trimStart()):(w=t[2].search(/[^ ]/),w=w>4?1:w,a=k.slice(w),w+=t[1].length);let p=!1;if(!k&&/^ *$/.test(d)&&(s+=d+`
...
`,1)[0];if(d=y,this.options.pedantic&&(d=d.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),f.test(d)||x.test(d)||m.test(d)||b.test(e))break;if(d.search(/[^ ]/)>=w||!d.trim())a+=`
`+d.slice(w);else{if(p||k.search(/[^ ]/)>=4||f.test(k)||x.test(k)||b.test(k))break;a+=`
`+d}!p&&!d.trim()&&(p=!0),s+=y+`
