...
Please report this to https://github.com/markedjs/marked.`,e){let i="<p>An error occurred:</p><pre>"+E(n.message+"",!0)+"</pre>";return t?Promise.resolve(i):i}if(t)return Promise.reject(n);throw n}};var P=new ie;function v(l,e){return P.parse(l,e)}v.options=v.setOptions=function(l){return P.setOptions(l),v.defaults=P.defaults,ve(v.defaults),v};v.getDefaults=se;v.defaults=M;v.use=function(...l){return P.use(...l),v.defaults=P.defaults,ve(v.defaults),v};v.walkTokens=function(l,e){return P.walkTokens(l,e)};v.parseInline=P.parseInline;v.Parser=j;v.parser=j.parse;v.Renderer=Z;v.TextRenderer=U;v.Lexer=N;v.lexer=N.lex;v.Tokenizer=H;v.Hooks=q;v.parse=v;var _t=v.options,Et=v.setOptions,Rt=v.use,It=v.walkTokens,Nt=v.parseInline;var jt=j.parse,Lt=N.lex;var Ne=`.notebook-viewer {
  position: fixed;
  top: 44px;
  left: 0;
  right: 0;
