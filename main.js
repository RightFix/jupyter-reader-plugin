(()=>{var je=Object.create;var te=Object.defineProperty;var Oe=Object.getOwnPropertyDescriptor;var qe=Object.getOwnPropertyNames;var Pe=Object.getPrototypeOf,Me=Object.prototype.hasOwnProperty;var fe=a=>{throw TypeError(a)};var De=(a,e,t)=>e in a?te(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var He=(a,e)=>()=>(e||a((e={exports:{}}).exports,e),e.exports);var Ze=(a,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of qe(e))!Me.call(a,i)&&i!==t&&te(a,i,{get:()=>e[i],enumerable:!(n=Oe(e,i))||n.enumerable});return a};var Be=(a,e,t)=>(t=a!=null?je(Pe(a)):{},Ze(e||!a||!a.__esModule?te(t,"default",{value:a,enumerable:!0}):t,a));var A=(a,e,t)=>De(a,typeof e!="symbol"?e+"":e,t),Fe=(a,e,t)=>e.has(a)||fe("Cannot "+t);var ge=(a,e,t)=>e.has(a)?fe("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(a):e.set(a,t);var J=(a,e,t)=>(Fe(a,e,"access private method"),t);var ke=He((B,ne)=>{(function(a,e){typeof B=="object"&&typeof ne=="object"?ne.exports=e():typeof define=="function"&&define.amd?define([],e):typeof B=="object"?B.tag=e():a.tag=e()})(B,(function(){return(function(){"use strict";var a={145:function(p,c,h){function k(b,f){(f==null||f>b.length)&&(f=b.length);for(var x=0,y=Array(f);x<f;x++)y[x]=b[x];return y}h.d(c,{A:function(){return k}})},284:function(p,c,h){function k(b){return k=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(f){return typeof f}:function(f){return f&&typeof Symbol=="function"&&f.constructor===Symbol&&f!==Symbol.prototype?"symbol":typeof f},k(b)}h.d(c,{A:function(){return k}})},458:function(p,c,h){h.d(c,{A:function(){return f}});var k=h(145),b=h(800);function f(x){return(function(y){if(Array.isArray(y))return(0,k.A)(y)})(x)||(function(y){if(typeof Symbol!="undefined"&&y[Symbol.iterator]!=null||y["@@iterator"]!=null)return Array.from(y)})(x)||(0,b.A)(x)||(function(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)})()}},800:function(p,c,h){h.d(c,{A:function(){return b}});var k=h(145);function b(f,x){if(f){if(typeof f=="string")return(0,k.A)(f,x);var y={}.toString.call(f).slice(8,-1);return y==="Object"&&f.constructor&&(y=f.constructor.name),y==="Map"||y==="Set"?Array.from(f):y==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(y)?(0,k.A)(f,x):void 0}}}},e={};function t(p){var c=e[p];if(c!==void 0)return c.exports;var h=e[p]={exports:{}};return a[p](h,h.exports,t),h.exports}t.d=function(p,c){for(var h in c)t.o(c,h)&&!t.o(p,h)&&Object.defineProperty(p,h,{enumerable:!0,get:c[h]})},t.o=function(p,c){return Object.prototype.hasOwnProperty.call(p,c)};var n={};t.d(n,{default:function(){return u}});var i=t(458),o=t(284),r=t(800);function s(p,c){return(function(h){if(Array.isArray(h))return h})(p)||(function(h,k){var b=h==null?null:typeof Symbol!="undefined"&&h[Symbol.iterator]||h["@@iterator"];if(b!=null){var f,x,y,E,S=[],z=!0,R=!1;try{if(y=(b=b.call(h)).next,k===0){if(Object(b)!==b)return;z=!1}else for(;!(z=(f=y.call(b)).done)&&(S.push(f.value),S.length!==k);z=!0);}catch(j){R=!0,x=j}finally{try{if(!z&&b.return!=null&&(E=b.return(),Object(E)!==E))return}finally{if(R)throw x}}return S}})(p,c)||(0,r.A)(p,c)||(function(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)})()}function l(p,c){(c==null||c>p.length)&&(c=p.length);for(var h=0,k=Array(c);h<c;h++)k[h]=p[h];return k}var g=["svg","path","circle","rect","line","polyline","polygon","ellipse","g","defs","use","symbol","text","tspan","textPath","marker","linearGradient","radialGradient"];function u(){for(var p=arguments.length,c=new Array(p),h=0;h<p;h++)c[h]=arguments[h];if(typeof c[1]=="string"||typeof c[2]=="string"){var k=s(c,1)[0],b=typeof c[2]=="string"?c[2]:void 0,f=typeof c[1]=="string"?c[1]:void 0,x=c.find((function(O){return O&&!Array.isArray(O)&&(0,o.A)(O)==="object"}))||{},y=c.find((function(O){return Array.isArray(O)}))||[];return b&&(x.id=b),f&&(x.className=f),m(k,y,x)}if(c=c.filter((function(O){return O!=null})),Array.isArray(c[1])){var E=s(c,3),S=E[0],z=E[1],R=z===void 0?[]:z,j=E[2];return m(S,R,j===void 0?{}:j)}var C=s(c,3),X=C[0],I=C[1],Le=I===void 0?{}:I,de=C[2];return m(X,de===void 0?[]:de,Le)}function m(p){var c,h=arguments.length>1&&arguments[1]!==void 0?arguments[1]:[],k=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};if(Array.isArray(k)&&(h=k,k={}),typeof p=="function")return p(k,h);if(p instanceof Node)c=p;else{if(typeof p!="string")throw new Error("Invalid tag ".concat((0,o.A)(p)));c=g.includes(p)?document.createElementNS("http://www.w3.org/2000/svg",p):document.createElement(p)}!k.children&&Array.isArray(h)&&h.length&&(k.children=h);var b=k.ref;return delete k.ref,Object.keys(k).forEach((function(f){var x=k[f];if(x!==void 0)switch(f){case"child":d(c,[x]);break;case"children":if(!Array.isArray(x))throw new Error("children must be an array of Nodes");d(c,x.flat());break;case"attr":Object.keys(x).forEach((function(S){var z=x[S];z!==void 0&&c.setAttribute(S,z)}));break;case"style":typeof x=="string"?c.setAttribute("style",x):Object.keys(x).forEach((function(S){var z=x[S];z!==void 0&&(c.style[S]=z)}));break;case"dataset":for(var y in x){var E=x[y];if(E===void 0)return;c.dataset[y]=E}break;case"on":Object.keys(x).forEach((function(S){var z=x[S];z!==void 0&&z.forEach((function(R){c.addEventListener(S,R)}))}));break;default:g.includes(p)&&["number","string","bigint"].includes((0,o.A)(x))||/-/.test(f)?c.setAttribute(f,x):c[f]=x}})),b&&b.instanceOfRef&&(b.el=c),c}function d(p,c){var h,k=(function(f,x){var y=typeof Symbol!="undefined"&&f[Symbol.iterator]||f["@@iterator"];if(!y){if(Array.isArray(f)||(y=(function(C,X){if(C){if(typeof C=="string")return l(C,X);var I={}.toString.call(C).slice(8,-1);return I==="Object"&&C.constructor&&(I=C.constructor.name),I==="Map"||I==="Set"?Array.from(C):I==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(I)?l(C,X):void 0}})(f))||x&&f&&typeof f.length=="number"){y&&(f=y);var E=0,S=function(){};return{s:S,n:function(){return E>=f.length?{done:!0}:{done:!1,value:f[E++]}},e:function(C){throw C},f:S}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var z,R=!0,j=!1;return{s:function(){y=y.call(f)},n:function(){var C=y.next();return R=C.done,C},e:function(C){j=!0,z=C},f:function(){try{R||y.return==null||y.return()}finally{if(j)throw z}}}})(c);try{for(k.s();!(h=k.n()).done;){var b=h.value;Array.isArray(b)?d(p,b.flat()):(b=w(b))&&p.appendChild(b)}}catch(f){k.e(f)}finally{k.f()}}function w(p){if(typeof p=="function")return w(p());if(p instanceof Promise){var c=document.createTextNode("");p.then((function(k){if(Array.isArray(k))return(k=k.flat()).forEach((function(b){(b=w(b))&&c.before(b)})),void c.remove();(k=w(k))?c.replaceWith(k):c.remove()})),p=c}else if(p instanceof Text)"clone"in p&&(p=p.clone());else if(!(p instanceof Node)){var h=(0,o.A)(p);if(!["number","bigint","string"].includes(h)||h==="string"&&!p)return null;p=u.text("".concat(p))}return p}return window&&!window.tag&&(window.tag=u),Object.defineProperties(u,{get:{value:function(p){return document.querySelector(p)}},getAll:{value:function(p){var c=document.querySelectorAll(p);return(0,i.A)(c)}},text:{value:function(p){return document.createTextNode(p)}}}),n.default})()}))});var T=Be(ke());function se(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var D=se();function $e(a){D=a}var ve=/[&<>"']/,Qe=new RegExp(ve.source,"g"),Ae=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Ue=new RegExp(Ae.source,"g"),Ge={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},me=a=>Ge[a];function _(a,e){if(e){if(ve.test(a))return a.replace(Qe,me)}else if(Ae.test(a))return a.replace(Ue,me);return a}var We=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function Xe(a){return a.replace(We,(e,t)=>(t=t.toLowerCase(),t==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}var Je=/(^|[^\[])\^/g;function v(a,e){let t=typeof a=="string"?a:a.source;e=e||"";let n={replace:(i,o)=>{let r=typeof o=="string"?o:o.source;return r=r.replace(Je,"$1"),t=t.replace(i,r),n},getRegex:()=>new RegExp(t,e)};return n}function xe(a){try{a=encodeURI(a).replace(/%25/g,"%")}catch(e){return null}return a}var Q={exec:()=>null};function be(a,e){let t=a.replace(/\|/g,(o,r,s)=>{let l=!1,g=r;for(;--g>=0&&s[g]==="\\";)l=!l;return l?"|":" |"}),n=t.split(/ \|/),i=0;if(n[0].trim()||n.shift(),n.length>0&&!n[n.length-1].trim()&&n.pop(),e)if(n.length>e)n.splice(e);else for(;n.length<e;)n.push("");for(;i<n.length;i++)n[i]=n[i].trim().replace(/\\\|/g,"|");return n}function K(a,e,t){let n=a.length;if(n===0)return"";let i=0;for(;i<n;){let o=a.charAt(n-i-1);if(o===e&&!t)i++;else if(o!==e&&t)i++;else break}return a.slice(0,n-i)}function Ke(a,e){if(a.indexOf(e[1])===-1)return-1;let t=0;for(let n=0;n<a.length;n++)if(a[n]==="\\")n++;else if(a[n]===e[0])t++;else if(a[n]===e[1]&&(t--,t<0))return n;return-1}function ye(a,e,t,n){let i=e.href,o=e.title?_(e.title):null,r=a[1].replace(/\\([\[\]])/g,"$1");if(a[0].charAt(0)!=="!"){n.state.inLink=!0;let s={type:"link",raw:t,href:i,title:o,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=!1,s}return{type:"image",raw:t,href:i,title:o,text:_(r)}}function Ve(a,e){let t=a.match(/^(\s+)(?:```)/);if(t===null)return e;let n=t[1];return e.split(`
